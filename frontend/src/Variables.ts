...
https://localhost:44390/api/user/myasha    - пользователь по login

https://localhost:44390/api/user + json    - создание пользователя

https://localhost:44390/api/user/3         - удаление пользователя по id

https://localhost:44390/api/user/3  + json - редактирвоание пользователя по id



https://localhost:44390/api/post            - все посты

https://localhost:44390/api/post/title/test - посты по title

https://localhost:44390/api/post/text/test  - посты по text
